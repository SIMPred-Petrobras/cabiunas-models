# Análise de falha — Equipamento B-0302C

## Qual falha estamos tentando predizer

- **Equipamento:** B-0302C
- **Falha(s) registrada(s):** *"Falha no motor elétrico com aumento de vibração"*
- **Data(s) da(s) falha(s):** 2024-08-30
- **Task ClearML (produção, real):** `2c5e3091a9354b639d7dc8944d9729a3`
- **Nº de eventos de falha documentados:** 1

## Modelo configurado

- **Sensor-alvo (o que o autoencoder tenta reconstruir):** Vibração Mancal Bomba LA
- **Sensores de entrada (contexto multivariado, além do alvo):** 5
  - Posição UV03201C
  - Corrente Media Motor
  - Corrente no Motor
...
| Métrica | Valor |
|---|---|
| Threshold calibrado (MAE) | 0.0514 |
| Taxa de anomalia (pontos/dia) | 16.4 |
...
|---|---|---|---|---|
| 1 | 2024-08-30 | Falha no motor elétrico com aumento de vibração | — | — (nenhum ponto anômalo nos 10 dias anteriores) |
...
### Zoom ±10 dias ao redor da falha (2024-08-30)
