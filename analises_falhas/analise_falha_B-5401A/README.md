# Análise de falha — Equipamento B-5401A

## Qual falha estamos tentando predizer

- **Equipamento:** B-5401A
- **Falha(s) registrada(s):** *"1. Motor em curto (10/08/2024); 2. Queima do segundo motor (09/12/2024)"*
- **Data(s) da(s) falha(s):** 2024-08-10; 2024-12-09
- **Task ClearML (produção, real):** `c4ea20d303ae4aaa95ca5cdfce5e2a5f`
- **Nº de eventos de falha documentados:** 2

## Modelo configurado

- **Sensor-alvo (o que o autoencoder tenta reconstruir):** Corrente
- **Sensores de entrada (contexto multivariado, além do alvo):** 6
  - Indicador de Velocidade
  - Pressão de Descarga
  - Temperatura Mancal Bomba LNA
  - Temperatura Mancal Bomba LA
  - Temperatura Mancal Motor LA
  - Pressão de Sucção

- **Total de sensores no grupo (entrada multivariada):** 7
...
| Métrica | Valor |
|---|---|
| Threshold calibrado (MAE) | 0.0001 |
| Taxa de anomalia (pontos/dia) | 1.2 |
| Alarmes documentados | 2 |
| Alarmes com anomalia detectada na janela (±48h) | 0 / 2 (hit_rate = 0.00) |
...
|---|---|---|---|---|
| 1 | 2024-08-10 | 1. Motor em curto (10/08/2024) | — | — (nenhum ponto anômalo nos 10 dias anteriores) |
| 2 | 2024-12-09 | 2. Queima do segundo motor (09/12/2024) | — | — (nenhum ponto anômalo nos 10 dias anteriores) |
