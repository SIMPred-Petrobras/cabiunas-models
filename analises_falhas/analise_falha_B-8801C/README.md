# Análise de falha — Equipamento B-8801C

## Qual falha estamos tentando predizer

- **Equipamento:** B-8801C
- **Falha(s) registrada(s):** *"Vibração elevada mancal LA motor e bomba"*
- **Data(s) da(s) falha(s):** 2024-07-05
- **Task ClearML (produção, real):** `08735c4f5da14dfcbef800893188c08c`
- **Nº de eventos de falha documentados:** 1

## Modelo configurado

- **Sensor-alvo (o que o autoencoder tenta reconstruir):** Vibração Bomba LA
- **Sensores de entrada (contexto multivariado, além do alvo):** 4
  - Temperatura Motor LA
  - Temperatura Motor LNA
  - Vibração Bomba LNA
  - Pressão Decsrga

- **Total de sensores no grupo (entrada multivariada):** 5
...
| Métrica | Valor |
|---|---|
| Threshold calibrado (MAE) | 0.0216 |
| Taxa de anomalia (pontos/dia) | 0.2 |
...
|---|---|---|---|---|
| 1 | 2024-07-05 | Vibração elevada mancal LA motor e bomba | — | — (nenhum ponto anômalo nos 10 dias anteriores) |
...
### Zoom ±10 dias ao redor da falha (2024-07-05)
