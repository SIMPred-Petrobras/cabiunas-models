# Análise de falha — Equipamento B-4064A

## Qual falha estamos tentando predizer

- **Equipamento:** B-4064A
- **Falha(s) registrada(s):** *"Roçamento interno do rotor com a carcaça da bomba"*
- **Data(s) da(s) falha(s):** 2024-08-30 07:58
- **Task ClearML (produção, real):** `62aab58491c04d93a95af28f291a4417`
- **Nº de eventos de falha documentados:** 1

## Modelo configurado

- **Sensor-alvo (o que o autoencoder tenta reconstruir):** Vibração Bomba LNA
...
| Métrica | Valor |
|---|---|
| Threshold calibrado (MAE) | 0.0389 |
| Taxa de anomalia (pontos/dia) | 11.3 |
...
|---|---|---|---|---|
| 1 | 2024-08-30 07:58 | Roçamento interno do rotor com a carcaça da bomba | 2024-08-28 04:40:00 | 51.3h (~2.1 dias) antes |
...
### Zoom ±10 dias ao redor da falha (2024-08-30 07:58)
