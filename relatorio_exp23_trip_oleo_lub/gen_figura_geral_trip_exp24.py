"""Figura geral: serie bruta do sensor-alvo (954005_624_PI_0308) do EXP24
(so filtro de duracao + portao de volatilidade -- 100% hit_rate/2
alarmes, 5,74%-8,25% FP conforme percentil) com as anomalias detectadas
sobrepostas e cada ocorrencia de alarme de TRIP (PALL_6240309, catalogo
inteiro) marcada como linha vertical tracejada.

Uso:
    python3 /home/dvar/REPO_CABIUNAS/cabiunas-models/relatorio_exp23_trip_oleo_lub/gen_figura_geral_trip_exp24.py
"""
import matplotlib
matplotlib.use("Agg")
...
ax.set_xlabel("tempo")
ax.set_title("EXP24 (duração + volatilidade) -- anomalias x alarmes de TRIP (PALL_6240309)")
ax.legend(loc="upper left", fontsize=9, frameon=True)
fig.tight_layout()

out_path = os.path.join(OUT, "serie_geral_trip_exp24.png")
