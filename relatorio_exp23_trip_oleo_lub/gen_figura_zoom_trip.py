...
onde o EXP16c efetivamente detectou algo perto de cada um dos 2 alarmes
de TRIP do periodo OOS -- pra ver o que o modelo "viu" de perto.

Uso:
    python3 /home/dvar/REPO_CABIUNAS/cabiunas-models/relatorio_exp23_trip_oleo_lub/gen_figura_zoom_trip.py
"""
import matplotlib
matplotlib.use("Agg")
...
# janela de zoom = min/max dos pontos detectados perto do alarme (+-2h de folga)
windows = []
...
fig.suptitle("EXP23 (com pilha de portões) -- zoom nos 2 alarmes de TRIP (OOS), 4 sensores", fontsize=12)
fig.tight_layout(rect=[0, 0, 1, 0.97])

out_path = os.path.join(OUT, "serie_zoom_trip_exp23.png")
