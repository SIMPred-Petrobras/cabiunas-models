...
Uso:
    PYTHONPATH=. python scripts/pca_monitoramento_sistema/reproducao_francisco_v6.py
"""
import os
import sys
...
task = Task.init(
    ...
    task_name="pca-walkforward::monitoramento_sistema_v6_reproducao_francisco",
    output_uri=True,
...
print("\nOK - fim do script v6 (reproducao Francisco)", flush=True)
task.mark_completed(status_message="v6: reproducao da politica de producao do Francisco concluida com sucesso.")
task.close()
