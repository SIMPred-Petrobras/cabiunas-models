...
\caption{Todas as estratégias testadas nesta seção, no mesmo plano
detecção$\times$custo do relatório de decisão da equipe. EXP37 fica
isolado no canto superior esquerdo -- melhor detecção, menor custo,
simultaneamente.}
\end{figure}
...
O grupo de óleo (EXP29/31) não foi reavaliado nesta rodada -- é o
próximo passo natural, replicando a mesma separação (pressão de óleo
isolada + o mesmo canal de alarme de processo).
